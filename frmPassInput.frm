...
Begin VB.Form frmPassInput 
   ...
   End
End
Attribute VB_Name = "frmPassInput"
...
On Error Resume Next
Dim lpPass As String
lpPass = txtPassCof.Text
If PasswordChecksum(lpPass) = True Then
With frmMain
...
End If
End Sub
Private Sub txtPassCof_Change()
On Error Resume Next
If txtPassCof.Text = "" Then
Command1.Enabled = False
Else
Command1.Enabled = True
End If
If Len(txtPassCof.Text) = 0 Then
Command1.Enabled = False
Else
Command1.Enabled = True
End If
